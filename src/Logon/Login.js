...
class Login extends Component {
    ...
    render() {
        return (<div className="card">
            ...
            <p onClick={this.handleNewUser} className="change-page">New User? Sign Up</p>
            <p onClick={() => console.log('Handle Forgot Password')} className="change-page">Forgot Password? Reset Now</p>
        </div>);
    }
}
